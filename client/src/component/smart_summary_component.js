...
function SmartSummary() {
  ...
  return (
    <div className='flex flex-col mt-2 mb-4 md:mb-0 w-full max-w-screen-lg h-[50vh] md:h-full overflow-auto p-4 border-2 border-gray-500 shadow-md bg-white mx-auto'>
