...
function ExtractOutput() {
  ...
  return (
    <div className='flex flex-col mt-2 md:mt-0 w-full xl:max-w-screen-lg h-[50vh] md:h-full overflow-auto p-4 border-2 border-gray-500 shadow-md bg-white mx-auto'>
