...
function App() {
  ...
  return (
    <div className="flex flex-col justify-between h-screen border-2 border-gray-200">
      ...
      <div className="flex flex-row justify-between h-screen m-4">
        ...
        <div className='flex flex-col border-2 border-gray-500 w-full bg-gray-200'>
